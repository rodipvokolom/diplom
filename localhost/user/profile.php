    ...
    <div class="prof__wrapper">
        <div class="user__tab">
            ...
            <div class="user__pic">
                ...
                <div class="user__edit"><img src="../assets/img/misc/gear.png" alt=""><a href="profile_edit.php?sender=profile">Редактировать профиль</a></div>
                <?endif;?>
